...
[#release-0_13_0]
=== 0.14.0.B Official https://archive.apache.org/dist/plc4x/0.14.0.B/apache-plc4x-0.13.0-source-release.zip[source release] [ https://downloads.apache.org/plc4x/0.13.0/apache-plc4x-0.13.0-source-release.zip.sha512[SHA512] ] [ https://downloads.apache.org/plc4x/0.13.0/apache-plc4x-0.13.0-source-release.zip.asc[ASC] ]
