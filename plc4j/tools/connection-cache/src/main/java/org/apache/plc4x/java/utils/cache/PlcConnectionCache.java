...
public class PlcConnectionCache implements PlcConnectionManager {
    ...
    public PlcDriverManager getDriverManager() {
        // YOFC: the factory this cache was built with may itself be a PlcDriverManager
        // (e.g. DefaultPlcDriverManager); expose it for tag preparation and URL lookups.
        return connectionFactory instanceof PlcDriverManager pdm ? pdm : null;
    }
