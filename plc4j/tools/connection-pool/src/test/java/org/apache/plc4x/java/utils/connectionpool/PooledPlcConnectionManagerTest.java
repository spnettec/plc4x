...
class PooledPlcConnectionManagerTest implements WithAssertions {

    private static Logger LOGGER = LoggerFactory.getLogger(PooledPlcConnectionManagerTest.class);

    private PooledPlcConnectionManager SUT = new PooledPlcConnectionManager(pooledPlcConnectionFactory -> {
    ...
    void setUp() throws Exception {
        Map<String, PlcDriver> driverMap = (Map) FieldUtils.getField(PooledPlcConnectionManager.class, "driverMap", true).get(SUT);
    ...
    public void testOtherConstructors() {
        assertThat(new PooledPlcConnectionManager()).isNotNull();
        assertThat(new PooledPlcConnectionManager(new PoolKeyFactory())).isNotNull();
        assertThat(new PooledPlcConnectionManager(PooledPlcConnectionManager.class.getClassLoader())).isNotNull();
        assertThat(new PooledPlcConnectionManager(
