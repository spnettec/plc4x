...
public abstract class PooledPlcConnectionFactory extends BaseKeyedPooledObjectFactory<AbstractPoolKey, PlcConnection> {
    ...
    @Override
    public void destroyObject(AbstractPoolKey key, PooledObject<PlcConnection> p) throws Exception {
        p.getObject().close();
    }

    @Override
    public boolean validateObject(AbstractPoolKey key, PooledObject<PlcConnection> p) {
