 ...
 * @author heyoulin
 */
public abstract class AbstractPoolKey {
    protected final String url;
    protected final PlcAuthentication plcAuthentication;

    public AbstractPoolKey(String url, PlcAuthentication plcAuthentication) {
        this.url = url;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AbstractPoolKey)) {
            return false;
        }
        AbstractPoolKey poolKey = (AbstractPoolKey) o;
    ...
    public String toString() {
        return "PoolKey{" +
            "url='" + url + '\'' +
            (plcAuthentication != PooledPlcConnectionManager.noPlcAuthentication ? ", plcAuthentication=" + plcAuthentication : "") +
            '}';
    }
}