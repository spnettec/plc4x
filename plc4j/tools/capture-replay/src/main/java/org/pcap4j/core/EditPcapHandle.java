...
import static org.pcap4j.core.PcapHandle.TimestampPrecision.MICRO;
 ...
 * @since pcap4j 0.9.1
 */
public final class EditPcapHandle implements Closeable {

    private static final Logger logger = LoggerFactory.getLogger(EditPcapHandle.class);
    ...
    EditPcapHandle(Pointer handle, PcapHandle.TimestampPrecision timestampPrecision) {
        this.handle = handle;
        this.dlt = getDltByNative();
        this.timestampPrecision = timestampPrecision;
    }

    private EditPcapHandle(EditPcapHandle.Builder builder) throws PcapNativeException {
        ...
        try {
            ...
            if (builder.isRfmonSet) {
                try {
                    int rc = NativeMappings.PcapLibrary.INSTANCE.pcap_set_rfmon(handle, builder.rfmon ? 1 : 0);
                    if (rc != 0) {
                        throw new PcapNativeException(getError(), rc);
                    }
            ...
            if (builder.timestampPrecision != null) {
                try {
                    int rc =
                            NativeMappings.PcapLibrary.INSTANCE.pcap_set_tstamp_precision(
                    ...
                    if (rc == 0) {
                        ...
                        StringBuilder sb =
                                new StringBuilder(100)
                                        ...
                                        .append(PcapHandle.TimestampPrecision.MICRO)
                                        .append(" is set instead.");

                        logger.error(sb.toString());
                        this.timestampPrecision = PcapHandle.TimestampPrecision.MICRO;
                    }
                } catch (UnsatisfiedLinkError e) {
            ...
            if (builder.isImmediateModeSet) {
                try {
                    int rc =
                            NativeMappings.PcapLibrary.INSTANCE.pcap_set_immediate_mode(handle, builder.immediateMode ? 1 : 0);
                    if (rc != 0) {
                        throw new PcapNativeException(getError(), rc);
                    }
                } catch (UnsatisfiedLinkError e) {
    ...
    /**
     * @return a {@link PcapHandle.SwappedType SwappedType} object.
     * @throws NotOpenException if this PcapHandle is not open.
     */
    public PcapHandle.SwappedType isSwapped() throws NotOpenException {
        ...
        switch (rc) {
        case 0:
            return PcapHandle.SwappedType.NOT_SWAPPED;
        case 1:
            return PcapHandle.SwappedType.SWAPPED;
        case 2:
            return PcapHandle.SwappedType.MAYBE_SWAPPED;
        default:
     ...
     * @throws NotOpenException if this PcapHandle is not open.
     */
    public BpfProgram compileFilter(String bpfExpression, BpfProgram.BpfCompileMode mode, Inet4Address netmask)
     ...
     */
    public void setFilter(String bpfExpression, BpfProgram.BpfCompileMode mode, Inet4Address netmask)
            throws PcapNativeException, NotOpenException {
        if (bpfExpression == null || mode == null || netmask == null) {
            StringBuilder sb = new StringBuilder();
            sb.append("bpfExpression: ")
     ...
     * @throws NullPointerException if any of arguments are null.
     */
    public void setFilter(String bpfExpression, BpfProgram.BpfCompileMode mode)
            throws PcapNativeException, NotOpenException {
    ...
    public PcapHandle.BlockingMode getBlockingMode() throws PcapNativeException, NotOpenException {
        ...
        if (rc == 0) {
            return PcapHandle.BlockingMode.BLOCKING;
        } else if (rc > 0) {
            return PcapHandle.BlockingMode.NONBLOCKING;
        } else {
            throw new PcapNativeException(errbuf.toString(), rc);
        }
    }
    ...
    public byte[] getNextRawPacket() throws NotOpenException {
        ...
        if (packet != null) {
            ...
            originalLengths.set(NativeMappings.pcap_pkthdr.getLen(headerP));
            return packet.getByteArray(0, NativeMappings.pcap_pkthdr.getCaplen(headerP));
        } else {
            return null;
        }
    }
     ...
     * @throws NotOpenException if this PcapHandle is not open.
     */
    public void loop(int packetCount, EditPacketListener listener)
            throws PcapNativeException, InterruptedException, NotOpenException {
        loop(packetCount, listener, EditPcapHandle.SimpleExecutor.getInstance());
    }
     ...
     * instead of {@link #loop(int, EditPacketListener)} in order to prevent the pcap buffer from
     * overflowing.
     *
     * @param packetCount the number of packets to capture. -1 is equivalent to infinity. 0 may result
     *     in different behaviors between platforms and pcap library versions.
     ...
     * @throws NotOpenException if this PcapHandle is not open.
     */
    public void loop(int packetCount, EditPacketListener listener, Executor executor)
            throws PcapNativeException, InterruptedException, NotOpenException {
        ...
        doLoop(packetCount, new EditPcapHandle.GotPacketFuncExecutor(listener, dlt, executor));
    }
    ...
    public void loop(int packetCount, RawPacketListener listener, Executor executor)
        ...
        doLoop(packetCount, new EditPcapHandle.GotRawPacketFuncExecutor(listener, executor));
    }
     ...
     * @throws NotOpenException if this PcapHandle is not open.
     */
    public int dispatch(int packetCount, EditPacketListener listener)
            throws PcapNativeException, InterruptedException, NotOpenException {
        return dispatch(packetCount, listener, EditPcapHandle.SimpleExecutor.getInstance());
    }
     ...
     * @throws NotOpenException if this PcapHandle is not open.
     */
    public int dispatch(int packetCount, EditPacketListener listener, Executor executor)
            throws PcapNativeException, InterruptedException, NotOpenException {
        if (listener == null || executor == null) {
            StringBuilder sb = new StringBuilder();
            sb.append("listener: ").append(listener).append(" executor: ").append(executor);
        ...
        return doDispatch(packetCount, new EditPcapHandle.GotPacketFuncExecutor(listener, dlt, executor));
    }
    ...
    public int dispatch(int packetCount, RawPacketListener listener, Executor executor)
        ...
        return doDispatch(packetCount, new EditPcapHandle.GotRawPacketFuncExecutor(listener, executor));
    }
    ...
    public PcapStat getStats() throws PcapNativeException, NotOpenException {
        ...
        try {
            ...
            if (Platform.isWindows()) {
                ...
                Pointer psp = NativeMappings.PcapLibrary.INSTANCE.win_pcap_stats_ex(handle, pcapStatSize);
                if (!getError()
    ...
    private static final class SimpleExecutor implements Executor {
        ...
        private static final EditPcapHandle.SimpleExecutor INSTANCE = new EditPcapHandle.SimpleExecutor();

        public static EditPcapHandle.SimpleExecutor getInstance() {
            return INSTANCE;
        }
    ...
    private final class GotPacketFuncExecutor implements NativeMappings.pcap_handler {
        ...
        private final EditPacketListener listener;
        private final Executor executor;

        public GotPacketFuncExecutor(EditPacketListener listener, DataLinkType dlt, Executor executor) {
            this.dlt = dlt;
     ...
     * PcapNetworkInterface#openLive(int, PcapNetworkInterface.PromiscuousMode, int) PcapNetworkInterface#openLive} does
    ...
    public static final class Builder {
        ...
        private PcapHandle.TimestampPrecision timestampPrecision = null;
        private PcapHandle.PcapDirection direction = null;
         ...
         */
        public EditPcapHandle.Builder snaplen(int snaplen) {
         ...
         * @return this Builder object for method chaining.
         */
        public EditPcapHandle.Builder promiscuousMode(PcapNetworkInterface.PromiscuousMode promiscuousMode) {
         ...
         * @return this Builder object for method chaining.
         */
        public EditPcapHandle.Builder rfmon(boolean rfmon) {
            this.rfmon = rfmon;
         ...
         * @return this Builder object for method chaining.
         */
        public EditPcapHandle.Builder timeoutMillis(int timeoutMillis) {
         ...
         * @return this Builder object for method chaining.
         */
        public EditPcapHandle.Builder bufferSize(int bufferSize) {
         ...
         * @return this Builder object for method chaining.
         */
        public EditPcapHandle.Builder timestampPrecision(
         ...
         * @return this Builder object for method chaining.
         */
        public EditPcapHandle.Builder direction(PcapHandle.PcapDirection direction) {
         ...
         * @return this Builder object for method chaining.
         */
        public EditPcapHandle.Builder immediateMode(boolean immediateMode) {
         ...
         * @throws PcapNativeException if an error occurs in the pcap native library.
         */
        public EditPcapHandle build() throws PcapNativeException {
            return new EditPcapHandle(this);
        }
    }
}
