...
public class S7StringFixedLengthTag extends S7Tag {
    ...
    public S7StringFixedLengthTag(TransportSize dataType, MemoryArea memoryArea,
        ...
        this(dataType, memoryArea, blockNumber, byteOffset, bitOffset, numElements,
            stringLength, dataType == TransportSize.WSTRING ? "UTF-16" : null);
    }
