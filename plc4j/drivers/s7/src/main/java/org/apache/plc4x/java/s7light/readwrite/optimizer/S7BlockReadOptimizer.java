...
public class S7BlockReadOptimizer extends S7Optimizer {
    ...
    public static class S7TagChunk extends S7Tag {
        ...
        public S7TagChunk(TransportSize dataType, MemoryArea memoryArea, int blockNumber, int byteOffset, byte bitOffset, int numElements, Map<PlcTag, String> chunkTags, int curPartIndex, int totalPartNumber, int totalPartSize,String stringEncoding) {
