...
public class BulkAccessApi {
  ...
  /**
   * Access to multiple datalayer nodes
   * Requests to multiple datalayer nodes with one request
   * @param type  (optional, default to read)
   * @param bulkRequestInner The data for the bulk request (optional
   * @return List&lt;BulkResponseInner&gt;
   * @throws ApiException if fails to make API call
   */
  public List<BulkResponseInner> bulkRequest(String type, List<BulkRequestInner> bulkRequestInner) throws ApiException {
    Object localVarPostBody = bulkRequestInner;
    ...
    TypeReference<List<BulkResponseInner>> localVarReturnType = new TypeReference<List<BulkResponseInner>>() {};
