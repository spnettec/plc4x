 ...
 * @param stringEncoding Optional tag-level string encoding override.
...
public record ResolvedAdsTag(
    ...
    public ResolvedAdsTag(long indexGroup, long indexOffset, long sizeInBytes,
                          String dataTypeName, PlcValueType plcValueType,
                          int stringLength,
                          List<AdsDataTypeArrayInfo> remainingArrayInfo) {
        this(indexGroup, indexOffset, sizeInBytes, dataTypeName, plcValueType,
            stringLength, null, remainingArrayInfo);
    }
}
