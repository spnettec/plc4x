...
public class PlcBIT extends PlcIECValue<Boolean> {

    private static final String VALUE_OUT_OF_RANGE = "Value of is required for a %s Value";

    public static PlcBIT of(Object value) {
        if(value == null) {
            value = 0;
        }
        if (value instanceof PlcBIT) {
            return (PlcBIT) value;
        } else if (value instanceof Boolean) {
            return new PlcBIT((Boolean) value);
        } else if (value instanceof Byte) {
            return new PlcBIT((Byte) value);
        } else if (value instanceof Short) {
            return new PlcBIT((Short) value);
        } else if (value instanceof Integer) {
            return new PlcBIT((Integer) value);
        } else if (value instanceof Long) {
            return new PlcBIT((Long) value);
        } else if (value instanceof Float) {
            return new PlcBIT((Float) value);
        } else if (value instanceof Double) {
            return new PlcBIT((Double) value);
        } else if (value instanceof BigInteger) {
            return new PlcBIT((BigInteger) value);
        } else if (value instanceof BigDecimal) {
            return new PlcBIT((BigDecimal) value);
        } else if (value instanceof Number) {
            return new PlcBIT(((Number) value).intValue());
        } else {
            return new PlcBIT(value.toString());
        }
    }

    public PlcBIT(Boolean value) {
        this.value = value;
        this.isNullable = true;
    }

    public PlcBIT(Byte value) {
        if (value == null) {
    ...
    public PlcBIT(BigInteger value) {
        if (value == null) {
            throw new PlcInvalidTagException(String.format(VALUE_OUT_OF_RANGE, this.getClass().getSimpleName()));
        }
    ...
    public PlcBIT(BigDecimal value) {
        if (value == null) {
            throw new PlcInvalidTagException(String.format(VALUE_OUT_OF_RANGE, this.getClass().getSimpleName()));
        }
