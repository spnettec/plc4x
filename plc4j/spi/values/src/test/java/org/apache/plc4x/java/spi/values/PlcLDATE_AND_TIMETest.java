...
public class PlcLDATE_AND_TIMETest {
    ...
    void testOfNanosecondsSinceEpoch() {
        LocalDateTime dateTime = LocalDateTime.of(1978, 3, 28, 12, 34, 56, 123_456_789);
        BigInteger nanosecondsSinceEpoch = BigInteger.valueOf(dateTime.toEpochSecond(ZoneOffset.UTC))
            .multiply(BigInteger.valueOf(1000_000_000))
            .add(BigInteger.valueOf(dateTime.getNano()));
        PlcLDATE_AND_TIME plcLDATE_AND_TIME = PlcLDATE_AND_TIME.ofNanosecondsSinceEpoch(nanosecondsSinceEpoch);
        assertEquals(dateTime, plcLDATE_AND_TIME.getDateTime());
    }
    ...
    void testGetPlcValueType() {
        ...
        assertEquals(PlcValueType.LDATE_AND_TIME, plcLDATE_AND_TIME.getPlcValueType());
    }
