...
public class PlcLDATE_AND_TIME extends PlcIECValue<LocalDateTime> {
    ...
    public static PlcLDATE_AND_TIME ofNanosecondsSinceEpoch(BigInteger nanosecondsSinceEpoch) {
        BigInteger epochSecond = nanosecondsSinceEpoch.divide(BigInteger.valueOf(1000_000_000));
        BigInteger nanoOfSecond = nanosecondsSinceEpoch.mod(BigInteger.valueOf(1000_000_000));
    ...
    public PlcValueType getPlcValueType() {
        return PlcValueType.LDATE_AND_TIME;
    }
