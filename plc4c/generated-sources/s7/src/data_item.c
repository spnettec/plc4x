...
// Parse function.
plc4c_return_code plc4c_s7_read_write_data_item_parse(plc4x_spi_context ctx, plc4c_spi_read_buffer* readBuffer, char* dataProtocolId, plc4c_s7_read_write_controller_type controllerType, int32_t stringLength, char* stringEncoding, plc4c_data** data_item) {
...
uint16_t plc4c_s7_read_write_data_item_length_in_bytes(plc4x_spi_context ctx, plc4c_data* data_item, char* data_protocol_id, plc4c_s7_read_write_controller_type controller_type, int32_t string_length, char* string_encoding) {
  return plc4c_s7_read_write_data_item_length_in_bits(ctx, data_item, data_protocol_id, controller_type, string_length, string_encoding) / 8;
}
