  ...
  while ((request_elements != NULL) && (payload_elements != NULL)) {
    ...
    if (num_elements > 1) {
      ...
      for (idx = 0; idx < num_elements ; idx++) {
        // TODO: Pass the plc-type along.
        plc4c_s7_read_write_data_item_parse(plc4x_spi_context_background(), read_buffer, data_protocol_id, plc4c_s7_read_write_controller_type_ANY, string_length,string_encoding, &data_item);
