...
_item, _err := readBuffer.ReadUint16("", 16)
	...
	numberOfBytesdata := int(utils.InlineIf((bool((packetLength) > (((((numberOfClasses) * ((2)))) + ((6)))))), func() any {return uint16(uint16(packetLength) - uint16((uint16((uint16(numberOfClasses) * uint16(uint16(2)))) + uint16(uint16(6)))))}, func() any {return uint16(uint16(0))}).(uint16))
