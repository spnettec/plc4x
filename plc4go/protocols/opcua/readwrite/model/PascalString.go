...
func (m *_PascalString) GetLengthInBits(ctx context.Context) uint16 {
	...
	lengthInBits += uint16(utils.InlineIf(bool((utils.InlineIf(bool((Utf8Length(ctx, m.GetStringValue())) == ((0))), func() any {return int32(-(int32(1)))}, func() any {return int32(Utf8Length(ctx, m.GetStringValue()))}).(int32)) == (-((1)))), func() any {return int32(int32(0))}, func() any {return int32(int32(utils.InlineIf(bool((Utf8Length(ctx, m.GetStringValue())) == ((0))), func() any {return int32(-(int32(1)))}, func() any {return int32(Utf8Length(ctx, m.GetStringValue()))}).(int32)) * int32(int32(8)))}).(int32))
...
func (m *_PascalString) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	_stringValueErr := writeBuffer.WriteString("stringValue", (utils.InlineIf(bool((utils.InlineIf(bool((Utf8Length(ctx, m.GetStringValue())) == ((0))), func() any {return int32(-(int32(1)))}, func() any {return int32(Utf8Length(ctx, m.GetStringValue()))}).(int32)) == (-((1)))), func() any {return ((0))}, func() any {return ((utils.InlineIf(bool((Utf8Length(ctx, m.GetStringValue())) == ((0))), func() any {return int32(-(int32(1)))}, func() any {return int32(Utf8Length(ctx, m.GetStringValue()))}).(int32)) * ((8)))})).(uint32), "UTF-8", (stringValue))
	if _stringValueErr != nil {
