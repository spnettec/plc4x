...
func DataItemParse(theBytes []byte, dataProtocolId string, stringLength int32, stringEncoding string) (api.PlcValue, error) {
	return DataItemParseWithBuffer(utils.NewReadBufferByteBased(theBytes), dataProtocolId, stringLength, stringEncoding)
}

func DataItemParseWithBuffer(readBuffer utils.ReadBuffer, dataProtocolId string, stringLength int32, stringEncoding string) (api.PlcValue, error) {
...
func DataItemSerialize(value api.PlcValue, dataProtocolId string, stringLength int32, stringEncoding string) ([]byte, error) {
	...
	if err := DataItemSerializeWithWriteBuffer(wb, value, dataProtocolId, stringLength, stringEncoding); err != nil {
		return nil, err
	}
	return wb.GetBytes(), nil
}

func DataItemSerializeWithWriteBuffer(writeBuffer utils.WriteBuffer, value api.PlcValue, dataProtocolId string, stringLength int32, stringEncoding string) error {
	m := struct {
