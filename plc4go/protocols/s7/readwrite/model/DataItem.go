...
func DataItemSerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer, value api.PlcValue, dataProtocolId string, controllerType ControllerType, stringLength int32, stringEncoding string) error {
	...
	case dataProtocolId == "IEC61131_CHAR": // CHAR
		// Manual Field (value)
		_valueErr := SerializeS7Char(ctx, writeBuffer, value, "UTF-8", m.GetStringEncoding())
		if _valueErr != nil {
			return errors.Wrap(_valueErr, "Error serializing 'value' field")
		}
	case dataProtocolId == "IEC61131_WCHAR": // CHAR
		// Manual Field (value)
		_valueErr := SerializeS7Char(ctx, writeBuffer, value, "UTF-16", m.GetStringEncoding())
		if _valueErr != nil {
			return errors.Wrap(_valueErr, "Error serializing 'value' field")
		}
	case dataProtocolId == "IEC61131_STRING": // STRING
		// Manual Field (value)
		_valueErr := SerializeS7String(ctx, writeBuffer, value, stringLength, "UTF-8", m.GetStringEncoding())
		if _valueErr != nil {
			return errors.Wrap(_valueErr, "Error serializing 'value' field")
		}
	case dataProtocolId == "IEC61131_WSTRING": // STRING
		// Manual Field (value)
		_valueErr := SerializeS7String(ctx, writeBuffer, value, stringLength, "UTF-16", m.GetStringEncoding())
		if _valueErr != nil {
			return errors.Wrap(_valueErr, "Error serializing 'value' field")
		}
	case dataProtocolId == "IEC61131_TIME": // TIME
