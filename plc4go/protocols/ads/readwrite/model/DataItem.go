...
func DataItemParse(readBuffer utils.ReadBuffer, plcValueType PlcValueType, stringLength int32, stringEncoding string) (api.PlcValue, error) {
...
func DataItemSerialize(writeBuffer utils.WriteBuffer, value api.PlcValue, plcValueType PlcValueType, stringLength int32, stringEncoding string) error {
	m := struct {
...
case plcValueType == PlcValueType_STRING : // STRING
			// Manual Field (value)
			_valueErr := SerializeAmsString(writeBuffer, value, m.StringLength, "UTF-8", m.StringEncoding)
			if _valueErr != nil {
				return errors.Wrap(_valueErr, "Error serializing 'value' field")
			}
case plcValueType == PlcValueType_WSTRING : // STRING
			// Manual Field (value)
			_valueErr := SerializeAmsString(writeBuffer, value, m.StringLength, "UTF-16", m.StringEncoding)
			if _valueErr != nil {
				return errors.Wrap(_valueErr, "Error serializing 'value' field")
			}
case plcValueType == PlcValueType_TIME : // TIME
