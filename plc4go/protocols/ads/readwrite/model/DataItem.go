...
func DataItemParse(ctx context.Context, theBytes []byte, plcValueType api.PlcValueType, stringLength int32, stringEncoding string) (api.PlcValue, error) {
	return DataItemParseWithBuffer(ctx, utils.NewReadBufferByteBased(theBytes), plcValueType, stringLength, stringEncoding)
}

func DataItemParseWithBuffer(ctx context.Context, readBuffer utils.ReadBuffer, plcValueType api.PlcValueType, stringLength int32, stringEncoding string) (api.PlcValue, error) {
	log := zerolog.Ctx(ctx)
	_ = log
...
func DataItemSerialize(value api.PlcValue, plcValueType api.PlcValueType, stringLength int32, stringEncoding string) ([]byte, error) {
...
func (m _DataItem) GetStringEncoding() string {
	return m.StringEncoding
}

func DataItemSerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer, value api.PlcValue, plcValueType api.PlcValueType, stringLength int32, stringEncoding string) error {
	log := zerolog.Ctx(ctx)
	_ = log
	m := _DataItem{
