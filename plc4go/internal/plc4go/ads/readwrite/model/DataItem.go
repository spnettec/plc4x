...
func DataItemParse(readBuffer utils.ReadBuffer, dataFormatName string, stringLength int32, stringEncoding string) (api.PlcValue, error) {
...
func DataItemSerialize(writeBuffer utils.WriteBuffer, value api.PlcValue, dataFormatName string, stringLength int32, stringEncoding string) error {
	m := struct {
